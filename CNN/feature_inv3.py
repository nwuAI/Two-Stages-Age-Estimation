...
for batch_features, batch_labels in load_preprocess_training_batch(batch_i, batch_size):
    ...
    invfea = np.row_stack((invfea, batch_fea))
    invfea_lab = np.row_stack((invfea_lab, batch_labels))
invfea = np.delete(invfea, 0, axis=0)
invfea_lab = np.delete(invfea_lab, 0, axis=0)
...
save_fea = 'invfc_layer_fea.mat'
save_fea_lab = 'invfc_layer_fea_lab.mat'
sio.savemat(save_fea,{'invfc_feature':invfea})
sio.savemat(save_fea_lab,{'invfc_feature_lab':invfea_lab})
print('存储完毕')
