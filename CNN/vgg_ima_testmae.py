...
test_features, test_labels = pickle.load(open('preprocess_test_3.p', mode='rb'))
...
test_features1 = test_features[0:200]
test_labels1 = test_labels[0:200]

with tf.Session() as sess:
    saver.restore(sess, save_model_path)
    MAEs = sess.run(abs11, feed_dict={x: test_features1, y: test_labels1, keep_prob: 1.0})
MAE = np.mean(MAEs)
